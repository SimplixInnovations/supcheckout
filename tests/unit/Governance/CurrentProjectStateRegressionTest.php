...
final class CurrentProjectStateRegressionTest extends TestCase {
    ...
    public function test_current_post_t3_gate_cannot_regress_before_r5_decision(): void {
        ...
        self::assertStringContainsString('Current operational gate | **R5/T4 architecture decision**', $start);
        ...
        self::assertStringContainsString('Current executable gate: **R5/T4 architecture decision**.', $status);
        self::assertStringContainsString('Current executable gate: **R5/T4 architecture decision**.', $handoff);
