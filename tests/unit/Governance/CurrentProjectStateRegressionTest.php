...
final class CurrentProjectStateRegressionTest extends TestCase {
    ...
    public function test_current_post_t3_gate_cannot_regress_before_r5_decision(): void {
        ...
        self::assertStringContainsString('Current operational gate | **R6 final qualification**', $start);
        ...
        self::assertStringContainsString('Current executable gate: **R6 final qualification**.', $status);
        self::assertStringContainsString('Current executable gate: **R6 final qualification**.', $handoff);
        ...
        self::assertStringContainsString('current_gate: r6-final-qualification', $contract);
