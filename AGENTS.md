...
The current successor program is **post-t3-ecosystem-hardening**, governed by `docs/superpowers/plans/2026-09-10-post-t3-ecosystem-hardening.md`. The completed R0/R1/E1-E3 integration milestone was squash-merged through PR #108 to `main` at `d69377d3e26831270a00151025d24cc64be9d36b`; no feature branch is intentionally retained after that merge.
